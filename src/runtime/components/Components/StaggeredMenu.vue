		...
		>
			...
			>
				...
				>
					<span
						ref="textWrapRef"
						class="inline-block relative w-(--sm-toggle-width,auto) min-w-(--sm-toggle-width,auto) h-[1em] overflow-hidden whitespace-nowrap sm-toggle-textWrap"
						aria-hidden="true"
					>
			...
			<aside
				...
				ref="panelRef"
				class="top-0 right-0 z-10 absolute flex flex-col bg-white backdrop-blur-md p-[6em_2em_2em_2em] h-full overflow-y-auto staggered-menu-panel"
