<template>
	<div ref="containerRef" class="relative size-full">
		<div
			...
			@mouseenter="(e: Event) => handleMouseEnter(item.id, e.currentTarget as HTMLElement)"
			@mouseleave="(e: Event) => handleMouseLeave(item.id, e.currentTarget as HTMLElement)"
		>
			<div
