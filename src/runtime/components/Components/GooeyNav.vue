				...
				>
					...
					>
						<NuxtLink
							...
							@click="(e: Event) => handleClick(e, index)"
							@keydown="(e: Event) => handleKeyDown(e, index)"
						>
							{{ item.label }}
						</NuxtLink>
					</li>
