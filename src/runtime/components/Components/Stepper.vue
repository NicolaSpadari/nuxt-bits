		...
		>
			...
			>
				<template v-for="(_, index) in stepsArray" :key="index + 1">
					<div
						...
						class="relative outline-none flex h-8 w-8 items-center justify-center rounded-full font-semibold" :class="[
			...
			>
				<AnimatePresence :initial="false" mode="sync" :custom="direction">
					...
					>
						<div v-if="slots.default && slots.default()[currentStep - 1]" ref="contentRef">
