<template>
	<div
		class="relative flex items-center justify-center" :class="[className]"
		:style="{
	...
	>
		...
		>
			<div v-if="!imageLoaded[idx]" class="absolute inset-0 z-[1] bg-[#0b0b0b] overflow-hidden shimmer-container" />
  ...
  <script setup lang="ts">
	...
	const imageLoaded = ref(Array.from({ length: props.images.length }).fill(false));
