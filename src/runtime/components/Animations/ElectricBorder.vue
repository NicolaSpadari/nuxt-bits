<template>
	<div ref="rootRef" class="relative isolate" :class="[className]" :style="style">
		<svg
			ref="svgRef"
			class="fixed opacity-0 size-0 pointer-events-none"
