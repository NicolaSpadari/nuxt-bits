		...
		<div ref="trackRef" class="flex w-max will-change-transform select-none motion-reduce:transform-none">
			...
			>
				<li
					...
					class="flex-none mr-[var(--logoloop-gap)] text-[length:var(--logoloop-logoHeight)] leading-[1]" :class="[
...
<script setup lang="ts">
	import { computed, defineComponent, h, nextTick, onMounted, onUnmounted, ref, useTemplateRef, watch } from "vue";
