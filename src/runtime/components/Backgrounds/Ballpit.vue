<template>
	<canvas ref="canvasRef" class="w-full h-full" :class="[props.className]" />
</template>
...
<script setup lang="ts">
	...
	class Z extends InstancedMesh {
		config: typeof BaseXConfig;
		physics: W;
		ambientLight: AmbientLight | undefined;
		light: PointLight | undefined;

		constructor(renderer: WebGLRenderer, params: Partial<typeof BaseXConfig> = {}) {
			const config = { ...BaseXConfig, ...params };
	...
	function createBallpit(canvas: HTMLCanvasElement, config: Partial<typeof BaseXConfig> = {}): CreateBallpitReturn {
		...
		function initialize(cfg: Partial<typeof BaseXConfig>) {
			if (spheres) {
				threeInstance.clear();
