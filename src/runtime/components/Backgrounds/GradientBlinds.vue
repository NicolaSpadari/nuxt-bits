<template>
	<div
		ref="containerRef"
		class="w-full h-full overflow-hidden relative" :class="[className]"
		:style="{
...
<script setup lang="ts">
	...
	`;
		...
		const uniforms: {
			...
			uColor0: { value: colorArr[0] ?? [0, 0, 0] },
			uColor1: { value: colorArr[1] ?? [0, 0, 0] },
			uColor2: { value: colorArr[2] ?? [0, 0, 0] },
			uColor3: { value: colorArr[3] ?? [0, 0, 0] },
			uColor4: { value: colorArr[4] ?? [0, 0, 0] },
			uColor5: { value: colorArr[5] ?? [0, 0, 0] },
			uColor6: { value: colorArr[6] ?? [0, 0, 0] },
			uColor7: { value: colorArr[7] ?? [0, 0, 0] },
